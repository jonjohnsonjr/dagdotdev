...
// Package logs exposes the loggers used for registry interactions.
//
// Adapted from github.com/google/go-containerregistry/pkg/logs.
package logs
...
var (
	...
	Trace    = log.New(io.Discard, "", log.LstdFlags)
)
